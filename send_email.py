...
We have alternative payment channels other than our Business Office. Just visit this link https://www.lormocolleges.com/payment-options. Please send your validated deposit slip to accounts@lormo.edu. You can also use this link https://access.lormo.edu/index.php?g=601 to send us the notification of your payment.
...
Emails:
    For Payment: accounts@lormo.edu
    Other concerns: businessoffice@lormo.edu
...
<body>
    <div class="container">
        <div class="header">
            <h2>Greetings with a lormo Smile!</h2>
        </div>
        <div class="content">
            <p>Dear Student,</p>
            ...
            <p>We offer alternative payment channels beyond our Business Office. Visit <a href="https://www.lormocolleges.com/payment-options">this link</a> for details. Send your validated deposit slip to <a href="mailto:accounts@lormo.edu">accounts@lormo.edu</a>. You can also notify us of your payment via <a href="https://access.lormo.edu/index.php?g=601">this link</a>.</p>
            <p>Thank you very much and keep safe!</p>
            <p>- Business Office</p>
        </div>
        <div class="footer">
            <p><strong>Emails:</strong><br>
            For Payment: <a href="mailto:accounts@lormo.edu" style="color: #ffffff;">accounts@lormo.edu</a><br>
            Other concerns: <a href="mailto:businessoffice@lormo.edu" style="color: #ffffff;">businessoffice@lormo.edu</a></p>
